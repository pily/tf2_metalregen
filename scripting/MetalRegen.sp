...
{
	CreateConVar("sm_rmetal_version", PLUGIN_VERSION, "Metal Regen Version", 0|FCVAR_SPONLY|FCVAR_REPLICATED|FCVAR_NOTIFY);
...
public Action:Timer_Regen(Handle:timer, any:user)
{
	...
	for (new i=1; i<=MaxClients; i++)
	{
		...
		if (GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 7
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 155
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 169
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 197
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 329
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 589 
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 662
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 795
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 804
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 884
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 893
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 902
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 911
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 960
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 969
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15073
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15074
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15075
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15114
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15139
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15140
		 || GetEntProp(weapon, Prop_Send, "m_iItemDefinitionIndex") == 15156
		 )
		{
